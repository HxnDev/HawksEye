...
import Drowsiness from './components/pages/Features/Drowsiness';
import EmptyParking from './components/pages/Features/EmptyParking';
      ...
      <Wrapper>
        <Navbar />
          <Routes>
            ...
            <Route path="/Parking" element={<EmptyParking/>} />
          </Routes>
          <Footer />
      </Wrapper>
    </Router>
